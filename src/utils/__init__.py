from src.utils.constants import (  # noqa: I001
    BENCHMARK_IMAGE_SIZE, BENCHMARK_NUM_IMAGES, BENCHMARK_REPEATS, BENCHMARK_WARMUP,
    CLASS_COLORS, CLASS_COLORS_LIST, CUSTOM_CLASSES,
    DEFAULT_CONFIDENCE, DEFAULT_IOU,
    TRACKING_BBOX_ALPHA, TRACKING_CONF_ALPHA, TRACKING_IOU, TRACKING_MAX_MISSED,
    env_or_default,
)
